        ...
        <Paper elevation={0} sx={{ p: { xs: 3, md: 4 }, borderRadius: 1, border: '1px solid', borderColor: 'divider' }}>
          ...
          <Box sx={{ '& p': { fontSize: '0.875rem', lineHeight: 1.6, mb: 1.5 }, '& li': { fontSize: '0.875rem', lineHeight: 1.6, mb: 0.5 } }}>
            ...
            <Typography paragraph>
              Welcome to RecipeBook. This Privacy Policy explains how RecipeBook ("RecipeBook", "we", "us" or "our") and its affiliates collect, use, disclose, and protect information when you use RecipeBook's services (the "Service") or interact with us, and your choices about the collection and use of your information. Capitalized terms that are not defined in this Privacy Policy have the meaning given to them in our Terms of Use. If you do not want your information processed in accordance with this Privacy Policy in general or any part of it, you should not use our Service. This policy applies to all users of the Service, including contributors, recipe creators, and users of our AI-powered features.
            </Typography>

            <SummaryBox>
              Welcome, here is our policy on privacy. This policy sets out how RecipeBook collects and uses the information that we collect about you when you use the Service. This policy also explains the choices that you can make about the way that we use your information.
            </SummaryBox>
            ...
            <SummaryBox>
              Whenever you load a page from RecipeBook, your browser sends us info about itself and your interactions with our Service. That info gets stored on our servers.
            </SummaryBox>
            ...
            <Typography paragraph>
              RecipeBook collects information in order to understand where its users are located for a number of reasons. It helps RecipeBook to localize and personalize content, comply with local laws, undertake aggregated analytics, understand if its users use RecipeBook for domestic, business or educational use, improve advertising efficiency and estimate the tax liability of RecipeBook. RecipeBook may collect your precise or approximate location: from you, when you provide, correct or confirm your location; by inferring your location from your IP address; and from our partners or your payment provider.
            </Typography>

            <SummaryBox>
              RecipeBook may collect and use your location data for personalization, analytics, advertising and tax purposes.
            </SummaryBox>
            ...
            <Typography paragraph>
              We receive content that you create within RecipeBook and media you upload, such as recipes, images, documents, videos, ingredient lists, cooking instructions, and metadata about your content including tags, cuisine types, and dietary preferences.
            </Typography>

            <SummaryBox>
              RecipeBook collects the content you upload to your account including all recipes, photos, and related data.
            </SummaryBox>
            ...
            <Typography paragraph>
              We use information about you to help us improve the RecipeBook Service and our users' experience, including by monitoring aggregate metrics such as total number of visitors, traffic, demographic patterns, popular recipes, and usage trends across different recipe categories.
            </Typography>
            ...
            <Typography paragraph sx={{ fontWeight: 500, mt: 2 }}>
              To promote and drive engagement with the RecipeBook Service:
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              From time to time RecipeBook may seek your consent to use your information for a particular purpose. Where you consent to our doing so, we will use it for that purpose. Where you no longer want us to use your information for that purpose you may withdraw your consent to this use.
            </Typography>
            ...
            <Typography paragraph>
              RecipeBook will use or disclose your information where we reasonably believe that such action is necessary to (a) comply with the law and the reasonable requests of law enforcement; (b) to enforce our Terms of Use or to protect the security or integrity of our Service; and/or (c) to exercise or protect the rights, property, or personal safety of RecipeBook, our users or others.
            </Typography>

            <SummaryBox>
              RecipeBook uses information about you for different reasons, including to provide, customize and improve the Service, for AI training, analytics, security, and to communicate with you.
            </SummaryBox>
            ...
            <SummaryBox>
              We might share some information about you with our affiliates, business partners and third-party service providers in order to provide the Service to you or to fulfill RecipeBook's legitimate business interests.
            </SummaryBox>
            ...
            <Typography paragraph>
              When you add friends on RecipeBook: Friends can view your shared recipes; You can view your friends' shared recipes; You can remove friends at any time. RecipeBook collects your friend connections and they may be shared with service providers where required to provide the Services. By default, your recipes are private and only visible to you unless you explicitly share them with friends.
            </Typography>
            ...
            <Typography paragraph>
              RecipeBook will also share your information with third parties in certain circumstances, such as where you consent to our sharing it with a third party for a particular purpose. You may choose to work with third-party products integrated into RecipeBook or third-party applications from within RecipeBook. Using third party products or integrating with third party applications could involve importing data from that third party to RecipeBook and/or exporting data from RecipeBook to that third party. These third-party products and apps are not controlled by us, and this privacy policy does not cover how third-party apps use your information. You should review the terms and conditions of any third party apps before connecting them to the Service.
            </Typography>

            <SummaryBox>
              We may share your data where you use third-party products or have integrated your use of RecipeBook with third-party applications that are not controlled by us.
            </SummaryBox>
            ...
            <Typography paragraph>
              RecipeBook cares about the security of your information, and uses appropriate safeguards to preserve the integrity and security of all information collected through the Service. To protect your privacy and security, we take reasonable steps (such as requesting a unique password) to verify your identity before granting you access to your account. You are responsible for maintaining the secrecy of your unique password and account information, and for controlling access to your email communications from RecipeBook, at all times. However, RecipeBook cannot ensure or warrant the security of any information you transmit to RecipeBook or guarantee that information on the Service may not be accessed, disclosed, altered, or destroyed. Your privacy settings may also be affected by changes to the functionality of third party sites and services that you add to the RecipeBook Service, such as social networks. RecipeBook is not responsible for the functionality or security measures of any third party.
            </Typography>
            ...
            <Typography paragraph>
              Please refer to your mobile device or browser's technical information for instructions on how to delete and disable cookies, and other tracking/recording tools. Depending on your type of device, it may not be possible to delete or disable tracking mechanisms on your mobile device. Note that disabling cookies and/or other tracking tools prevents RecipeBook or its business partners from tracking your browser's activities in relation to the Service. However, doing so may disable many of the features available through the Service.
            </Typography>

            <SummaryBox>
              If you want us to stop collecting information about you through cookies, there may be some settings you can adjust in your browser or device. But RecipeBook might not be personalized for you without it.
            </SummaryBox>
            ...
            <SummaryBox>
              You may have specific rights in relation to your information depending on where you live. RecipeBook provides you with controls in your account settings and you can access your privacy rights by emailing privacy@recipebook.app.
            </SummaryBox>
            ...
            <SummaryBox>
              If we post a link to a third party website on RecipeBook, we can't control what happens on the other end. The same applies if you let another site use your data on RecipeBook; the use of your information will be governed by the Privacy Policy of the third party.
            </SummaryBox>
